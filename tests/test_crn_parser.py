...
class TestCRNparser(unittest.TestCase):
  ...
  def test_parse_examples(self):
    ...
    output_processed = [[['A','B'], ['C'], [None]]], sorted(['A','B','C'])
    ...
    output_processed = [[['A','B'],['C'], ['10.8']]], sorted(['A','B','C'])
    #print parse_crn_string(input_string, process=False)
    #print parse_crn_string(input_string)
    ...
    output_processed = [[['A','B'],['C'], ['8']]], sorted(['A','B','C'])
    #print parse_crn_string(input_string, process=False)
    #print parse_crn_string(input_string)
    ...
    output_processed = [[['A','B'],['C'], [None]], [['A','B'],['C'],[None,None]]], sorted(['A','B','C'])
    #print parse_crn_string(input_string, process=False)
    #print parse_crn_string(input_string)
    ...
    output_processed = [[['A','B'],['C'], ['18']], [['A','B'],['C'], ['99','77']]], sorted(['A','B','C'])
    #print parse_crn_string(input_string, process=False)
    #print parse_crn_string(input_string)
    ...
    output_processed = [[['A', 'A', 'A', 'A', 'A'],['B','B','B','C','C'],[None]]], sorted(['A','B','C'])
    #print parse_crn_string(input_string)
